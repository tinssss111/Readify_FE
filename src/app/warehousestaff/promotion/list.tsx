...
export default function WarehouseStaffPromotionListView() {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            View available promotional campaigns and discount codes
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="grid gap-4 grid-cols-1 md:grid-cols-20">
            <div className="relative md:col-span-13">
        ...
        <CardContent className="pt-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                No promotional campaigns are available at the moment
              </p>
            </div>
          ) : (
            <>
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem asChild>
                              <Link
                                href={`/warehousestaff/promotion/${promotion._id}`}
                              >
